...
namespace UMS2026
{
    public partial class AdminForm : Form
    {
        ...
        {
            // Common hover handler for admin buttons
            if (sender is Button btn)
            {
                try {
                    btn.BackColor = System.Drawing.Color.FromArgb(45, 85, 150);
        ...
        {
            // Common leave handler for admin buttons
            if (sender is Button btn)
            {
                try {
                    btn.BackColor = System.Drawing.Color.FromArgb(30, 58, 95);
